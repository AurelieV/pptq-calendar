...
export class MyUserApi extends BaseLoopBackApi {
   ...
   *  - `` – `{}` -
   */
  public addRole(id: any, role: any): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MyUsers/:id/addRole";
    let _routeParams: any = {
   ...
   *  - `` – `{}` -
   */
  public removeRole(id: any, role: any): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MyUsers/:id/removeRole";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   *  - `users` – `{[object]}` -
   */
  public findByRole(role: any): Observable<MyUser> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MyUsers/findByRole";
    let _routeParams: any = {};
    ...
    if (role) _urlParams.role = role;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody);
    return result.map((instance: MyUser) => new MyUser(instance));
  }
   ...
   *  - `roles` – `{[string]}` -
   */
  public getAllRoles(context: any): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MyUsers/roles";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (context) _urlParams.context = context;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody);
    return result;
  }
   ...
   *  - `roles` – `{[string]}` -
   */
  public getPersistedRoles(id: any): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MyUsers/:id/persistedRoles";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
